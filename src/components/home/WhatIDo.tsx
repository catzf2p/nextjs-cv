            ...
            <div className='flex flex-col rounded-xl border border-slate-800/60 bg-slate-800/30 p-4 transition-all hover:shadow-xl md:flex-row'>
              ...
              <div className='md:ml-4'>
                ...
                <p className='text-center md:text-left'>
                  ...
                  cohesive codes to enhance the user experience. Participating in continuing education and training to remain current on
                  best practices, learn new programming languages.
                </p>
              </div>
            </div>
          </ScrollAnimation>
            ...
            <div className='flex flex-col rounded-xl border border-slate-800/60 bg-slate-800/30 p-4 transition-all hover:shadow-xl md:flex-row'>
              ...
              <div className='md:ml-4'>
                ...
                <p className='text-center md:text-left'>
                  ...
                  Track and report on project portfolio performance, provide a real-time, comprehensive, and prioritized view of all
                  projects.
                </p>
              </div>
            </div>
