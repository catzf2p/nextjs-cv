      ...
      <div className='w-ful min-w-full'>
        ...
        >
          <h2 className='flex items-center text-3xl font-normal'>
            ...
            <span className='bg-gradient-to-r from-purple-500 to-blue-700 bg-clip-text text-3xl font-bold text-transparent'>Training</span>
          </h2>
        </ScrollAnimation>
        <div className='mt-6'>
          <ScrollAnimation
          ...
          >
            <div className='flex flex-col rounded-xl border border-slate-800/60 bg-slate-800/30 shadow-xl md:flex-row'>
              ...
              <div className='flex flex-col p-6'>
                ...
                <p className='mt-2'>
                  Find out what are the updates and how it affects the individual and all businesses (small and large). Also discover what
                  are the first steps to become compliant. Finally, through case studies learn from mistakes made by others and take steps
                  to prevent them from happening to you.
                </p>
              </div>
            </div>
          </ScrollAnimation>
